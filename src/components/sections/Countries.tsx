  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-16 grid gap-7 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {countries.map((country) => (
            ...
            >
              ...
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-r from-primary to-secondary text-2xl font-bold text-white">
        ...
        <div className="mt-20 rounded-3xl bg-gradient-to-r from-primary to-secondary p-10 text-white shadow-xl">
